        ...
        <>
            ...
            <div className="filter-section marketplaces">
                <div className="marketplace-logos">
                    ...
                    >
                        <img src="./img/marketplace-logo/wb-logo.png" alt="Wildberries"/>
                    ...
                    <button
                        ...
                        onClick={handleMarketplaceButtonClick}
                    >
                        <img src="./img/marketplace-logo/yandex-market-logo.png" alt="Я.Маркет"/>
                        <span>Я.Маркет</span>
                    </button>
                    <button
                        ...
                        onClick={handleMarketplaceButtonClick}
                    >
                        <img src="./img/marketplace-logo/ozon-logo.png" alt="Ozon"/>
                        <span>OZON</span>
                    </button>
                    <button
                        ...
                        onClick={handleMarketplaceButtonClick}
                    >
                        <img src="./img/marketplace-logo/avito-logo.png" alt="Avito"/>
                        <span>AVITO</span>
                    </button>
                    <button
                        ...
                        onClick={handleMarketplaceButtonClick}
                    >
                        <img src="./img/marketplace-logo/boxberry-logo.png" alt="Boxberry"/>
                        <span>Boxberry</span>
                    </button>
                </div>
            </div>
