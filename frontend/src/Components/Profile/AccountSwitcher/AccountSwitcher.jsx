...
function AccountSwitcher({toggleIsShowCompanySelector}) {
    return (
        <button className="flex px-3 py-2 justify-between g-[10px] bg-[var(--second-background-color)] rounded-[10px] text-[0.9rem] items-center relative z-0" onClick={() => toggleIsShowCompanySelector()}>
