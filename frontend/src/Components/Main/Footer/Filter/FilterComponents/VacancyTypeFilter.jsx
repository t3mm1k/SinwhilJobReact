// VacancyTypeFilter.js
import React from "react";

function VacancyTypeFilter({ selectedVacancyType, onChange }) {
    ...
    return (
        <div className="filter-section">
            <button
                className={`toggle-button ${selectedVacancyType === "full-time" ? "active" : ""}`}
                value="full-time"
                onClick={handleVacancyTypeButtonClick}
            >
                <span className={`circle ${selectedVacancyType === "full-time" ? "active" : ""}`}></span>
                Постоянная работа
            </button>
            <button
                className={`toggle-button ${selectedVacancyType === "part-time" ? "active" : ""}`}
                value="part-time"
                onClick={handleVacancyTypeButtonClick}
            >
